with b as (
   ...
   , c as (select CURRENCYID, PFX_SYMBOL, SFX_SYMBOL, CURRENCY_SYMBOL, DECIMAL_POINT, GROUP_SEPARATOR, SCALE
           from CURRENCYFORMATS_V1)
   , r as (select cf.CURRENCYID, ifnull(ch.CURRVALUE, 1) CURRVALUE
